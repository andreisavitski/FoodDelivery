...
import static by.pvt.fooddelivery.constant.AppConstants.BEARER_PREFIX;
import static by.pvt.fooddelivery.constant.AppConstants.HEADER_NAME;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (StringUtils.isNotEmpty(username) && SecurityContextHolder.getContext().getAuthentication() == null) {
            UserDetails userDetails = compositeUserDetailService.loadUserByUsername(username);
